...
/*			_root.addNamespaceDeclaration("jnevents", NS_JNEVENTS);
	...
	public static void repeatDaily(CalendarDate date){
	    Vector reps = (Vector) getRepeatableEvents();
        Vector v = new Vector();
        for (int i = 0; i < reps.size(); i++) {
            IEvent ev = (IEvent) reps.get(i);
	...
	public static void repeatWeekly(CalendarDate date){
	    Vector reps = (Vector) getRepeatableEvents();
        Vector v = new Vector();
        for (int i = 0; i < reps.size(); i++) {
            IEvent ev = (IEvent) reps.get(i);
	...
	public static void repeatMonthly(CalendarDate date){
	    Vector reps = (Vector) getRepeatableEvents();
        Vector v = new Vector();
        for (int i = 0; i < reps.size(); i++) {
            IEvent ev = (IEvent) reps.get(i);
	...
	public static void repeatYearly(CalendarDate date){
	    Vector reps = (Vector) getRepeatableEvents();
        Vector v = new Vector();
        for (int i = 0; i < reps.size(); i++) {
            IEvent ev = (IEvent) reps.get(i);
