...
//        Util.debug("Task " + t.getText());
        ...
        if (hasSubTasks(t.getID())) {
            Collection subTasks = getAllSubTasks(t.getID());
            effortFinder(expendedEffort, totalEffort, t, subTasks);
            
            res =progress(expendedEffort,totalEffort, res, t); 
            return res;
        }
        else {
    ...
    public void effortFinder(long expendedEffort, long totalEffort, ITask t, Collection subTasks) {
    ...
    public long[] progress(long expendedEffort, long totalEffort, long[] res, ITask t){
